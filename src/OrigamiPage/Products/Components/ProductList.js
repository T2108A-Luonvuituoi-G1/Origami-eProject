            ...
            <>
                ...
                >
                    ...
                    <div className='product-hightlight'>
                        ...
                        <h1 className='poster-hightlight'><b>Posted by {this.state.poster2}</b></h1>
                    ...
                    <div className='product-items'>
                        <div className='p-item-little p-lotus'>
                            ...
                            <div className='div-p'>
                                Model name: Hoa Sen <br /> Author: Dang Viet Tan </div>
                        ...
                        <div className='p-item-little p-fox'>
                            ...
                            <div className='div-p font-fox'>< IoPersonSharp />Posted by {this.state.poster6} </div >
                        ...
                        <div className='p-item-little p-frame'>
                            ...
                            <div className='div-p font-frame'>< IoPersonSharp />Posted by {this.state.poster5} </div >
                        ...
                        <div className='p-item-little p-japan'>
                            ...
                            <div className='div-p font-jp'>< IoPersonSharp />Posted by {this.state.poster5} </div >
                        </div>
                    </div>
